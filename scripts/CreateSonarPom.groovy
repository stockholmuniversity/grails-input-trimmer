...
target(createPom: "Create a POM for Sonar") {
    ...
    String group
    if (!args) {
        ant.input addProperty: "pom.group", message: "Enter the groupId (se.su.it.grails.plugins)",
            defaultvalue: 'se.su.it.grails.plugins'
    ...
    // target location
    pomFile = "${grailsSettings.baseDir}/sonar.xml"
